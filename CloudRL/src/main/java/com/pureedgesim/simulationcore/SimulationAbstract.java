...
public abstract class SimulationAbstract {
	 ...
	 */
	protected  String simConfigfile = "/Users/guneetwalia/Desktop/PureEdgeSim/CloudRL (1)/rl-cloud/CloudRL/src/main/java/pruebas/settings/simulation_parameters.properties";

	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String applicationsFile = "/Users/guneetwalia/Desktop/PureEdgeSim/CloudRL (1)/rl-cloud/CloudRL/src/main/java/pruebas/settings/applications.xml";
	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String edgeDataCentersFile = "/Users/guneetwalia/Desktop/PureEdgeSim/CloudRL (1)/rl-cloud/CloudRL/src/main/java/pruebas/settings/edge_datacenters.xml";
	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String edgeDevicesFile = "/Users/guneetwalia/Desktop/PureEdgeSim/CloudRL (1)/rl-cloud/CloudRL/src/main/java/pruebas/settings/edge_devices.xml";
	
	/**
	 * @see #setCustomFilePath(String, Files)
	 */
	protected  String cloudFile = "/Users/guneetwalia/Desktop/PureEdgeSim/CloudRL (1)/rl-cloud/CloudRL/src/main/java/pruebas/settings/cloud.xml";
