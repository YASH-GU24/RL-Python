...
public class DataCentersManager {
	...
	public void generateDatacentersAndDevices() throws Exception {
		...
		System.out.print("Size of Datacenters List=" + datacentersList.size()); //105
		System.out.print("Size of VmList=" + vmList.size());   //=140
		System.out.print("Size of Orchestrator List=" + orchestratorsList.size());	   //=100
	}
	...
	public void generateEdgeDevices() throws Exception {
		...
		SimLog.println( "What is the Length of Edge Device List"+ edgeDevicesList.getLength());
		...
		for (int i = 0; i < edgeDevicesList.getLength(); i++) {
			...
			//Print to Test
			SimLog.println("Inside GenerateEdgeDEVICES: " + edgeNode);
	...
	private void generateDataCenters(String file, SimulationParameters.TYPES type) throws Exception {
		...
		for (int i = 0; i < datacenterList.getLength(); i++) {
			System.out.println("Length of Datacenter List"+ datacenterList.getLength());
